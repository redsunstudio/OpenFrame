...
export const metadata: Metadata = {
  title: 'Terms of Service | KreatorKit',
  description: 'Terms of Service for KreatorKit by IPEK TECH LLC.',
};
        ...
        <div className="prose prose-sm prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground/80">
          <section>
            ...
            <p>
              ...
              &ldquo;our&rdquo;), governing your access to and use of the KreatorKit platform,
          ...
          <section>
            ...
            <p>
              KreatorKit is a video review and approval platform that enables creative professionals
