...
export const metadata: Metadata = {
  title: 'Privacy Policy | KreatorKit',
  description: 'Privacy Policy for KreatorKit by IPEK TECH LLC.',
};
        ...
        <div className="prose prose-sm prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground/80">
          <section>
            ...
            <p>
              ...
              company, operates the KreatorKit platform at open-frame.net (the
