...
export const metadata: Metadata = {
  title: 'Refund Policy | KreatorKit',
  description: 'Refund Policy for KreatorKit by IPEK TECH LLC.',
};
      ...
      <main className="mx-auto max-w-[900px] px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground/80">
          <section>
            ...
            <p>
              This Refund Policy applies to all paid subscriptions to the KreatorKit platform
