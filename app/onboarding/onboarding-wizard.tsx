    ...
    <div className="text-center space-y-8">
      ...
      <div className="space-y-3">
        <h2 className="text-3xl font-bold tracking-tight">
          Welcome to KreatorKit, {userName.split(' ')[0]}!
        </h2>
        <p className="text-base text-muted-foreground max-w-md mx-auto">
          KreatorKit is your collaborative video review platform. Collect timestamped feedback,
  ...
  return (
    <div className="space-y-7">
      <div className="text-center space-y-3">
        ...
        <p className="text-base text-muted-foreground">
          KreatorKit supports two ways to add video content to your projects.
        </p>
      </div>
      ...
      <div className="grid gap-4">
        <div className="rounded-xl border p-5 space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Paste a link to any YouTube video. KreatorKit will pull in the title, thumbnail, and
